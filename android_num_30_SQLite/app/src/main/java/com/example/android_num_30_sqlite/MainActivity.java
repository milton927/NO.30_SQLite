...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        add = (Button)findViewById(R.id.add_data77);
        all = (Button)findViewById(R.id.view_all99);
        upDate = (Button)findViewById(R.id.up_date00);
        delete = (Button)findViewById(R.id.delete995454);
        addData();
        viewAll();
        Update();
        deleteData();
